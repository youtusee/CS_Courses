...
def setup_logger(name, output=None, loglevel: str = 'INFO'):
    """
    ...
    assert loglevel in ['DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'], \
        termcolor.colored("loglevel must be one of the following terms: 'DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'", 'red')
